...
#anim_plot(displacements,(), ground_motion,floor_heights, [1], anim_settings1) # plot with ground motion

anim_plot(displacements,(), ground_motion,floor_heights, [2,1,0], anim_settings2,"frame") # plot without ground motion
