...
#' # Lecture 10 - Earthquake ground motion simulation
...
earthquake_data = readdlm("/Users/crismoen/Documents/dev/StructuralDynamics/Fall_2022/Lecture_10/Imperial_Valley_1979.txt",Float64,dims=(711,8))
...
#Calculate the maximum force in structure.  This is can be considered the base shear if you idealize a building as an SDOF dynamic system.
V = k * maximum(u)  #N
